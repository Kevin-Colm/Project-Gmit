...
//query to get data from the venue and event tables.
//The DATE(NOW()) function can be used to get previous dates.
...
<h2>Past Events</h2>
 ...
 //While loop to get each row from the query and store it in variables
